      ...
      <div className={styles.container}>
        ...
        <div className={styles.tabletBox}>
          <form className={styles.balanceBox} onSubmit={updateBalance}>
            ...
            <div key={balanceFromStore /*это небольшой трюк, чтобы поле баланс обновлялось после изменения balanceFromStore несмотря на то, что оно uncontrollable*/}> 
               <input className={styles.moneyInput} name="balance" type="text" defaultValue={parseFloat(balanceFromStore).toFixed(2) + " UAH" } onChange={onBalanceInputChange}/>
            </div>
